...
SELECT 
    CASE "Bundesland"
        WHEN '1400' THEN 'Brandenburg' WHEN '1401' THEN 'Berlin' WHEN '1402' THEN 'Baden-Wuerttemberg'
        ...
        WHEN '1415' THEN 'Thueringen' ELSE 'Unbekannt'
    END AS "Bundesland",
    CAST(SUM("Bruttoleistung") AS NUMERIC(10,0)) AS total_power,
